                    ...
                    <div className="space-y-3 md:space-y-4">
                      {loading ? (
                        ...
                        pendingApplications.slice(0, 6).map((application) => {
                          ...
                          const activityTitle = application.status === 'approved' 
                           ...
                           return (
                            <div key={application.id} className="flex items-start gap-4 p-4 border rounded-lg hover:bg-accent/50 transition-colors">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Application <span className="font-medium text-card-foreground">
                                    {application.application_number || application.title || 'N/A'}
                                  </span> - {application.entity_name || 'No entity'}
                                </p>
